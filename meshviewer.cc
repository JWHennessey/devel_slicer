...
void create_menu(QMainWindow &w)
{
    ...
    QAction* sliceAct = new QAction(w.tr("Slice Mesh"), &w);
    QObject::connect(sliceAct, SIGNAL(triggered()), w.centralWidget(), SLOT(query_slice_mesh()));
    fileMenu->addAction(sliceAct);
}
